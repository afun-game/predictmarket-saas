...
import "github.com/nxsky/twill/runtime/version"

// The following types are used to check, at compile time, that every
// twill_gen.go file uses the codegen API version that is linked into the
// binary.
//
// It is best explained via an example. Imagine 'twill generate' is running
// with codegen version 0.1.0. For every package, 'twill generate' generates
// the following line:
//
