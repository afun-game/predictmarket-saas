...
type MethodLabels struct {
	...
	Generated bool   `twill:"servicetwill_generated"` // Is this an autogenerated metric?
}

// MethodMetrics contains metrics for a single Twill component method.
