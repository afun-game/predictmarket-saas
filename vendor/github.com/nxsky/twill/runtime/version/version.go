...
// Package version contains the version of the twill module and its
...
const (
	...
	// the deployer API version and the version of the Twill module.
	//
	// Instead, we use Twill module versions as deployer API versions.
	// For example, if we change the deployer API in v0.12.0 of Twill,
	// then we update the deployer API version to v0.12.0. If we don't change
	// the deployer API in v0.13.0 of Twill, then we leave the
