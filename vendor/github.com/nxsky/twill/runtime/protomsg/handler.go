...
var (
	httpRequestCounts = metrics.NewCounterMap[handlerLabels](
		"servicetwill_system_http_request_count",
		"Count of Twill HTTP requests received",
	)
	httpRequestErrorCounts = metrics.NewCounterMap[errorLabels](
		"servicetwill_system_http_request_error_count",
		"Count of Twill HTTP requests received that result in an error",
	)
	httpRequestLatencyMicros = metrics.NewHistogramMap[handlerLabels](
		"servicetwill_system_http_request_latency_micros",
		"Duration, in microseconds, of Twill HTTP request execution",
		imetrics.GeneratedBuckets,
	)
	httpRequestBytesReceived = metrics.NewHistogramMap[handlerLabels](
		"servicetwill_system_http_request_bytes_received",
		"Number of bytes received by Twill HTTP request handlers",
		imetrics.GeneratedBuckets,
	)
	httpRequestBytesReturned = metrics.NewHistogramMap[handlerLabels](
		"servicetwill_system_http_request_bytes_returned",
		"Number of bytes returned by Twill HTTP request handlers",
		imetrics.GeneratedBuckets,
	)
)
