...
// in log entries generated by Twill system components.
const SystemAttributeKey = "servicetwill/system"
...
type Options struct {
	App        string // Twill application (e.g., "todo")
	Deployment string // Twill deployment (e.g., "36105c89-85b1...")
	Component  string // Twill component (e.g., "Todo")
	Weavelet   string // Twill weavelet id (e.g., "36105c89-85b1...")
...
func (t *TestLogger) Log(entry *protos.LogEntry) {
	...
	case !t.verbose:
		...
		// override this behavior because, otherwise, twilltest benchmark
