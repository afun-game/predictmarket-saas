...
// Package tool contains utilities for creating Twill tools similar to
// twill-multi, twill-gke, and twill-gke-local.
package tool
...
func MainHelp(tool string, commands map[string]*Command) string {
	...
	return fmt.Sprintf(`Deploy and manage Twill programs.
