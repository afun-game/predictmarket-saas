...
import (
	...
	"github.com/nxsky/twill/internal/tool/config"
...
const (
	ConfigKey      = "github.com/nxsky/twill/single"
	ShortConfigKey = "single"
)

var deployCmd = tool.Command{
	Name:        "deploy",
	Description: "Deploy a Twill app",
	Help:        "Usage:\n  twill single deploy <configfile>",
...
func deploy(ctx context.Context, args []string) error {
	...
	cmd.Env = append(cmd.Environ(), "SERVICETWILL_CONFIG="+configFile)
