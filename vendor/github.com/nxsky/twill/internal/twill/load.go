...
// loadCollector collects load for a Twill component. As an example, imagine we
// have a load collector lc for a Twill component that owns slices [0, 10) and
...
type loadCollector struct {
	component string           // Twill component
