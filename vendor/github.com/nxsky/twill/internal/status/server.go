...
import (
	...
	"github.com/nxsky/twill/runtime/protomsg"
	protos "github.com/nxsky/twill/runtime/protos"
)

const (
	statusEndpoint     = "/debug/servicetwill/status"
	metricsEndpoint    = "/debug/servicetwill/metrics"
	prometheusEndpoint = "/debug/servicetwill/prometheus"
	profileEndpoint    = "/debug/servicetwill/profile"
)

// A Server returns information about a Twill deployment.
...
// /debug/servicetwill/ prefix. You can use a Client to interact with a Status server.
