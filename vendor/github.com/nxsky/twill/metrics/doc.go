...
// [NewHistogramMap]. Twill represents metric labels using structs.
...
//	    Bar string
//	}
//	var exampleLabeledCounter = twill.NewCounterMap[labels](
...
// name using a twill annotation.
//
//	type labels struct {
//	    Foo string                           // exported as "foo"
//	    Bar string `twill:"my_custom_name"` // exported as "my_custom_name"
//	}
//
// # Exporting Metrics
//
// Twill integrates metrics into the environment where your
// application is deployed. If you deploy a Twill application to
