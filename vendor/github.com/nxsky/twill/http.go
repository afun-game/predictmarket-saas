...
import (
	...
	"github.com/nxsky/twill/metrics"
...
type httpLabels struct {
	...
	Generated bool `twill:"servicetwill_generated"`
}
...
//
//   - servicetwill_http_request_count: Total number of requests.
//   - servicetwill_http_error_count: Total number of 4XX and 5XX replies.
//   - servicetwill_http_request_latency_micros: Execution latency in microseconds.
//   - servicetwill_http_request_bytes_received: Total number of request bytes.
//   - servicetwill_http_request_bytes_returned: Total number of response bytes
