-- Enable fee rates set at market creation by removing the constraints that
-- force zero rates. Idempotent so it also composes with the merchant-side
-- fee migration when that lands.
-- +goose Up
